...
class Seq2Seq(model.Model):
    ...
    def __init__(self, freq_dim, vocab_size, config):
        ...
        self.dec_rnn = nn.GRUCell(input_size=embed_dim,
                                  hidden_size=rnn_dim)
        #print("input_size is {}".format(embed_dim))
        #print("hidden_size is {}".format(rnn_dim))
    ...
    def forward_impl(self, x, y):
        print("type of x and y: {},{}".format(type(x),type(y)))
    ...
    def decode(self, x, y):
        ...
        """
        print("type of x,y:{},{}".format(type(x),type(y)))
